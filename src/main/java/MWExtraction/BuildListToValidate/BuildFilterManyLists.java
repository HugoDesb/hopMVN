 ...
 */
package MWExtraction.BuildListToValidate;
            	...
            	if(list_candidat_terms_validated.get(i).getIsTrueTerm()==0){
            		...
            		if(length_pattern==1){
            			if(nb_mot==1){
                            if(!t1gramme_is_in_stop_words(list_candidat_terms_validated.get(i).getTerm())){
                                t1gramme.add(list_candidat_terms_validated.get(i).toCSVLine());
                                n_gramme.add(list_candidat_terms_validated.get(i).toCSVLine());
                            }else{
                    ...
                    if(nb_mot==2){
                        if(!t2gramme_is_in_stop_words(list_candidat_terms_validated.get(i).getTerm())){
                            t2gramme.add(list_candidat_terms_validated.get(i).toCSVLine());
                            n_gramme.add(list_candidat_terms_validated.get(i).toCSVLine());
                        }else{
                            //System.out.println(list_candidat_terms_validated.get(i).getTerm());
                        }
                        ...
                        if(nb_mot==3){
                            if(!t3and4gramme_is_in_stop_words(list_candidat_terms_validated.get(i).getTerm())){
                                t3gramme.add(list_candidat_terms_validated.get(i).toCSVLine());
                                n_gramme.add(list_candidat_terms_validated.get(i).toCSVLine());
                            }else{
                                //System.out.println(list_candidat_terms_validated.get(i).getTerm());
                            }
                            ...
                            if(nb_mot>=4){
                                if(!t3and4gramme_is_in_stop_words(list_candidat_terms_validated.get(i).getTerm())){
                                    t4gramme.add(list_candidat_terms_validated.get(i).toCSVLine());
                                    n_gramme.add(list_candidat_terms_validated.get(i).toCSVLine());
                                }else{
                                    //System.out.println(list_candidat_terms_validated.get(i).getTerm());
                                }
