...
public class Split {
    ...
    private static String getBetweenParenthesis(String ligneTexte){
    ...
    private static String getBetweenCrochet(String ligneTexte){
    ...
    private static String getBetweenBraces(String ligneTexte){
