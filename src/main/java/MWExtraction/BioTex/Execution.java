...
public class Execution {
    ...
    static ArrayList<String> allSentences = new ArrayList<>();
    ...
    public static ArrayList<CandidatTerm> main_execution(
    	...
    	ArrayList<String> al_POS_Phrases = new ArrayList<>();
        ...
        */  
            ...
            //TermsReference = ValidationMesh.loadTrueTerms(language);
            ...
            if(typeSource == 1){//Single file
                ...
                //a set of files, it means a single document separated with flag
        ...
        ArrayList<CandidatTerm> list_candidat_terms_formatted = new ArrayList<CandidatTerm>();
        ...
        if(list_candidat_terms.size()>0 && al_POS_Phrases.size()>0){
            ...
            //list_candidat_terms_validated = ValidationECMT.Validate_All_Terms(list_candidat_terms);

            //Validation avec Hetop :
            list_candidat_terms_validated = ValidationHetop.Validate_All_Terms(list_candidat_terms);

            list_candidat_terms_formatted = Formatter.extend(list_candidat_terms_validated, allSentences);
        }
        //list_candidat_terms_validated = list_candidat_terms;

        return list_candidat_terms_formatted;
    }
}